                        ...
                        <div class="mt-6 border-t border-gray-100">
                            <dl class="divide-y divide-gray-100">
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <div class="mt-1">
                                            <textarea id="note" name="note" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-2">{{ old('note', $diary->note) }}</textarea>
                                        </div>
                                        @error('note')
                                        <div class="text-red-600">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <div class="mt-1">
                                            <textarea id="note01" name="note01" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-2">{{ old('note01', $diary->note01) }}</textarea>
                                        </div>
                                        @error('note01')
                                        <div class="text-red-600">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        <div class="mt-1">
                                            <textarea id="note02" name="note02" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md px-2">{{ $diary->note02 }}</textarea>
                                        </div>
                                        @error('note02')
                                        <div class="text-red-600">{{ $message }}</div>
                                        @enderror
